...
for L = 25:3:76
    ...
    string = ['group 1 :: L = ', num2str(L), ' (25:3:76)']
...
csvwrite('rmse_by_t_L_w_1.csv', rmse_result);
...
for L = 25:3:76
    ...
    string = ['group 2 :: L = ', num2str(L), ' (25:3:76)']
...
csvwrite('rmse_by_t_L_w_2.csv', rmse_result);
...
for L = 25:3:76
    ...
    string = ['group 3 :: L = ', num2str(L), ' (25:3:76)']
